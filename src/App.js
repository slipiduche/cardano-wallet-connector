...
export default class App extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            transactionIdLocked: "d87905c5b2f865471fab3269cc3798ebcb20c07422472e2cf87898fcc8846f07",
    ...
    buildBuyToken = async () => {
        ...
        const newBalanceString = (parseInt(this.state.balance) - this.state.manualFee - 10000000).toString()
        ...
        const datum = this.SellOfferList({
            aSeller: toHex(buyerBaseAddress.payment_cred().to_keyhash().to_bytes()),
            aSellPrice: '10000000',//this.state.aSellPrice,
            aCurrency: this.state.assetPolicyIdHex,
            aToken: this.state.assetNameHex
